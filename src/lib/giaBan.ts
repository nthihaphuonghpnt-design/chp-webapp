...
export const DON_THUE_NGOAI_SAFE_COLS =
  "id, don_hang_id, loai_dich_vu_thue, doi_tac_thue_ngoai_id, chi_tiet_van_chuyen_id, noi_dung, so_luong, don_gia, so_tien_da_chi, chi_ho, tinh_trang_thanh_toan, so_tien_da_thanh_toan, phuong_thuc_thanh_toan, nguon_thanh_toan, tam_ung_id, phieu_quyet_toan_id, hoa_don_id, ngay_thue, trang_thai, nguoi_nhap_id, created_at, updated_at";
