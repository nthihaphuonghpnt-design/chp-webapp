-- ============================================================================
-- Ban gop lai, AN TOAN CHAY NHIEU LAN, cua 0050 + 0051 + 0055 — dung khi
-- khong chac da chay phan nao truoc do (vd da tao lich_nghi_le/
-- don_xin_nghi_phep tu 0051 nhung chua tao cham_cong tu 0050). Moi trigger/
-- policy deu drop-if-exists truoc khi tao lai nen chay lai bao nhieu lan
-- cung khong loi.
-- ============================================================================
